...
export const APP = {
  ...
  selectedClass:null,
  attState:{}, attSaved:false, attSavedClasses:{},
  ...
  attViewDate:null, attRecords:{},
  showResolvedInjuries:false,
  inviteType:'coach',
};
...
export const SKILLS = [
  ...
  {id:'f2',level:'Foundation',event:'General',name:'Strong Arms',spot:'Form Spot',correct:'Arms fully extended, engaged. Elbows NOT locked.',cues:'Strong arm check! · Strong not straight!',drill:'Strong Arm Check — push on each arm.',errors:[{e:'Locked elbows',f:'Strong not locked!',c:'Strong arm check drill'}],deductions:[{d:'Bars — bent arms',v:'^0.20–0.50'}],principle:'Strong not Straight'},
  {id:'f3',level:'Foundation',event:'General',name:'Hollow Body',spot:'Form Spot',correct:'Lower back pressed flat, belly button to spine.',cues:'SQUISH THE BUG! · Push belly button to floor!',drill:'Squish the Bug — slide hand under lower back.',errors:[{e:'Arched lower back',f:'SQUISH THE BUG!',c:'Hollow body holds 10-30 sec'}],deductions:[{d:'Hollow (BHC)',v:'^0.20'}],principle:'Get it in the body not just the brain'},
  ...
  {id:'f6',level:'Foundation',event:'General',name:'Stick & Salute',spot:'Form Spot',correct:'Two foot landing, strong knees absorb, feet do not move. Arms raise tall after stick.',cues:"Land on hot lava — don't move! · Feet are GLUED! · Own it!",drill:'Jump and stick drills. Every landing = full freeze + salute.',errors:[{e:'Steps on landing',f:'Feet are GLUED!',c:'Jump and stick drills'}],deductions:[{d:'Steps on landing',v:'ea 0.10'},{d:'Failure to salute',v:'0.20'}],principle:'Gym culture starts at Level 1'},
  {id:'l1v1',level:'Level 1',event:'Vault',name:'Stretch Jump to Handstand Flatback',spot:'TRUE SPOT',mantra:'Run · Circle · Punch',correct:'Sprint → hurdle → punch → stretch jump → handstand → flat back.',cues:'Run · Circle · Punch! · Lean · Kick · Push! · Ankles before bums!',drill:'Mat progression: 8→16→24→32→36in rezi.',errors:[{e:'Piked handstand',f:'Push tall',c:'Handstand holds'},{e:'Bent arms',f:'Strong arms!',c:'Push-up holds'}],deductions:[{d:'Arms bent',v:'^0.50'},{d:'Arched body',v:'^0.30'}],principle:'Confidence before height. Always.',spotWarning:'TRUE SPOT — you are supporting an inverted athlete.'},
  {id:'l1b1',level:'Level 1',event:'Bars',name:'Pullover',spot:'TRUE SPOT',correct:'Chin up · Hips up · Toes over. Finish in front support.',cues:'Chin Up · Hips Up · Toes Over! · Barbie thumbs!',drill:'Chin-up hold → hip pop drill → toes-over on low bar.',errors:[{e:'One-foot takeoff',f:'Both feet together',c:'Two-foot jump'},{e:'Not in front support',f:'Push through to extended',c:'Front support holds'}],deductions:[{d:'Not in front support',v:'^0.10'}],principle:'Get it in the body not just the brain',spotWarning:'Hand under hips to guide over bar.'},
  {id:'l1b2',level:'Level 1',event:'Bars',name:'Cast',spot:'Form Spot',correct:'From front support — push hips away from bar, hollow line.',cues:'Push the bar away! · Hollow body!',drill:'Cast to wall — tap wall with toes.',errors:[{e:'Hips not leaving bar',f:'Push the bar AWAY',c:'Hip flexor stretches'}],deductions:[{d:'Not straight-hollow',v:'^0.20'}],principle:'Strong not Straight'},
  {id:'l1b3',level:'Level 1',event:'Bars',name:'Back Hip Circle',spot:'TRUE SPOT',correct:'Hollow body maintained throughout. Hip/thigh contact on bar.',cues:'Squish the bug all the way around! · Hips on the bar!',drill:'Spotted BHC. Hollow check before every attempt.',errors:[{e:'Losing hollow',f:'Squish the bug!',c:'Hollow holds'}],deductions:[{d:'No hollow',v:'^0.20'}],principle:'Get it in the body not just the brain',spotWarning:'Hand on upper back throughout.'},
  {id:'l1b4',level:'Level 1',event:'Bars',name:'Underswing Dismount',spot:'TRUE SPOT',correct:'Cast, pike, push bar away, extend to hollow, stick.',cues:'Push the bar away! · Reach long! · Stick it!',drill:'Spotted from low bar.',errors:[{e:'Hips hitting bar',f:'Pike and push AWAY',c:'Underswing on low bar'}],deductions:[{d:'No hollow',v:'^0.20'}],principle:'Confidence before height.',spotWarning:'Hand under lower back during flight.'},
  {id:'l1bm1',level:'Level 1',event:'Beam',name:'Straddle Mount',spot:'Form Spot',correct:"Jump to front support, 1/4 turn to straddle sit.",cues:"Don't squish Bob! · Strong arms!",drill:'Bob the sticker — land without squishing.',errors:[{e:'Collapsing arms',f:'Strong arms!',c:'Push-up holds on beam'}],deductions:[{d:'Not in front support',v:'^0.10'}],principle:'Get it in the body not just the brain'},
  ...
  {id:'l1fl1',level:'Level 1',event:'Floor',name:'Forward Roll',spot:'Form Spot',correct:'Tuck maintained. Do not push off with hands to stand.',cues:'Chin to chest! · Ball shape!',drill:'Cheese mat roll — incline helps.',errors:[{e:'Pushing off with hands',f:'Keep hands off floor',c:'Incline roll drills'}],deductions:[{d:'No tuck',v:'^0.20'}],principle:'Get it in the body not just the brain'},
  {id:'l1fl2',level:'Level 1',event:'Floor',name:'Cartwheel',spot:'Form Spot',correct:'Alternate hand placement, pass through vertical, lunge in/out.',cues:'Paint the ceiling! · One hand then the other!',drill:'Hand markers — tape X on floor.',errors:[{e:'Simultaneous hands',f:'One hand THEN the other!',c:'Hand marker drills'}],deductions:[{d:'Simultaneous hands',v:'0.10'}],principle:"Understand what you're asking the brain to do",safetyNote:'Do NOT teach cartwheel and handstand in same session.'},
  {id:'l1fl3',level:'Level 1',event:'Floor',name:'Backward Roll',spot:'Form Spot',correct:'Tuck maintained. Hands push through at top.',cues:'Ball shape! · Push those hands through!',drill:'Cheese mat. Crossed hands spot.',errors:[{e:'Hands before rolling',f:'Sit first — then roll',c:'Cheese mat drills'}],deductions:[{d:'No tuck',v:'^0.20'}],principle:'Get it in the body not just the brain',spotWarning:'Crossed hands: one on belly, one on back.'},
];
